...
# Questions and answers for math part of game
questions = {
...
def end(won):
    ...
    showscores = input("Would you like to see your math scores? [y, n]\n").replace(" ", "").lower()
    ...
    play_again = ask_choice("Would you like to play again?", ["yes", "no"]).replace(" ", "").lower()
...
def donut_river():
    ...
    if choice == "cave":
        ...
        aprint("You see a donut! You are exhausted and hungry.")
        aprint("You lunge for the donut, but you fall and hit your head on a rock!")
